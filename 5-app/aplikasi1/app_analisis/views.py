...
def analisis(request):
    ...
    if request.method == 'POST':
        ...
        tweets = tweepy.Cursor(API.search_tweets, q='shopeefood -filter:retweets', tweet_mode='extended',lang="id").items(1000)
        ...
        if df.empty:
            ...
            return render(request, 'analisis.html', {'report': report, 'user': handle})
